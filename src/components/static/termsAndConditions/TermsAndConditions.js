...
const TermsAndConditions = () => {
    return (
        <div className='btw-terms'>
            <Typography displayInline={false}>Terms and Conditions</Typography>
            <br />
            <Typography displayInline={false} variant='body'>
                Last updated: April 20, 2018
                <br /><br />
                Please read these Terms and Conditions ("Terms", "Terms and
                Conditions") carefully before using the https://bethewave.vote/
                website (the "Service") operated by BeTheWave ("us", "we", or "our").
                <br /><br />
            ...
            <br />
            <Typography displayInline={false}>Accounts</Typography>
            <br />
            <Typography displayInline={false} variant='body'>
                ...
                accurate, complete, and current at all times. Inaccurate, incomplete, or obsolete information may result in the immediate termination of
            ...
            <br />
            <Typography displayInline={false}>Intellectual Property</Typography>
            <br />
            <Typography displayInline={false} variant='body'>
                The Service and its original content, features and functionality are and
                will remain the exclusive property of BeTheWave and its licensors. The Service is protected by copyright, trademark, and other laws of
                ...
                without the prior written consent of BeTheWave.
            </Typography>
            <br />
            <Typography displayInline={false}>Links To Other Web Sites</Typography>
            <br />
            <Typography displayInline={false} variant='body'>
                Our Service may contain links to third party web sites or services that
                are not owned or controlled by BeTheWave
                <br /><br />
                BeTheWave has no control over, and assumes no responsibility for
                ...
                <br /><br />
                You acknowledge and agree that BeTheWave shall not be
            ...
            <br />
            <Typography displayInline={false}>Termination</Typography>
            <br />
            <Typography displayInline={false} variant='body'>
            ...
            <br />
            <Typography displayInline={false}>Indemnification</Typography>
            <br />
            <Typography displayInline={false} variant='body'>
                You agree to defend, indemnify and hold harmless BeTheWave and
                its licensee and licensors, and their employees, contractors, agents, officers and directors, from and against any and all claims, damages, obligations, losses, liabilities, costs or debt, and expenses (including
            ...
            <br />
            <Typography displayInline={false}>Limitation Of Liability</Typography>
            <br />
            <Typography displayInline={false} variant='body'>
                In no event shall BeTheWave, nor its directors, employees, partners, agents, suppliers, or affiliates, be liable for any indirect, incidental, special, consequential or punitive damages, including without
            ...
            <br />
            <Typography displayInline={false}>Disclaimer</Typography>
            <br />
            <Typography displayInline={false} variant='body'>
                ...
                BeTheWave its subsidiaries, affiliates, and its licensors do not warrant
            ...
            <br />
            <Typography displayInline={false}>Exclusions</Typography>
            <br />
            <Typography displayInline={false} variant='body'>
            ...
            <br />
            <Typography displayInline={false}>Governing Law</Typography>
            <br />
            <Typography displayInline={false} variant='body'>
                ...
                constitute the entire agreement between us regarding our Service, and supersede and replace any prior agreements we might have had
                between us regarding the Service.
            </Typography>
            <br />
            <Typography displayInline={false}>Changes</Typography>
            <br />
            <Typography displayInline={false} variant='body'>
            ...
            <br />
            <Typography displayInline={false}>Contact Us</Typography>
            <br />
            <Typography displayInline={false} variant='body'>
