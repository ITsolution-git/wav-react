    ...
    render() {
        return (
            <div className="btw-privacy">
                ...
                <p>
                Effective date: April 20, 2018<br/>
                BeTheWave ("us", "we", or "our") operates the <a href="https://bethewave.vote/">https://bethewave.vote/</a> website (the "Service").<br/>
                ...
                We use your data to provide and improve the Service. By using the Service, you agree to the collection and use of information in accordance with this policy. Unless otherwise defined in this Privacy Policy, terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, accessible from <a href="https://bethewave.vote/">https://bethewave.vote/</a><br/>
                </p><br/>
                ...
                <p>
                Cookies are small pieces of data stored on a User’s device.<br/>
                </p><br/>

                <h4><b>Data Controller</b></h4>
                ...
                <h4><b>Data Processor (or Service Providers)</b></h4>
                ...
                We may use your Personal Data to contact you with newsletters, marketing or promotional materials and other information that may be of interest to you. You may opt out of receiving any, or all, of these communications from us by contacting us.<br/>
                </p><br/>
                ...
                <h3><b>Use of Data</b></h3><br/>

                <p>
                BeTheWave uses the collected data for various purposes:<br/>
                <ul>
                ...
                BeTheWave will take all steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of your data and other personal information.<br/>
                </p><br/>

                <h3><b>Disclosure Of Data</b></h3><br/>

                <h4><b>Legal Requirements</b></h4>

                <p>
                BeTheWave may disclose your Personal Data in the good faith belief that such action is necessary to:<br/>
                <ul>
                <li>To comply with a legal obligation</li>
                <li>To protect and defend the rights or property of BeTheWave</li>
                ...
                <h3><b>"Do Not Track" Signals</b></h3><br/>
                ...
                <h3><b>Your Rights</b></h3><br/>

                <p>
                BeTheWave aims to take reasonable steps to allow you to correct, amend, delete, or limit the use of your Personal Data.<br/>
                ...
                You have the right to data portability for the information you provide to BeTheWave. You can request to obtain a copy of your Personal Data in a commonly used electronic format so that you can manage and move it.<br/>
                Please note that we may ask you to verify your identity before responding to such requests.<br/>
                </p><br/>

                <h3><b>Service Providers</b></h3><br/>
                ...
                <ul>
                    ...
                    <li>For more information on the privacy practices of Google, please visit the Google Privacy & Terms web page: <a href="http://www.google.com/intl/en/policies/privacy/">http://www.google.com/intl/en/policies/privacy/</a></li>
                </ul>

                </p><br/>

                <h3><b>Links To Other Sites</b></h3><br/>
                ...
                Privacy Policy of <a href="https://bethewave.vote/">https://bethewave.vote/</a>
                </p><br/>
            </div>
        );
    }
